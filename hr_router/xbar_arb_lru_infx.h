...
class xbar_arb_lru_infx : public XbarArbitration {
  ...
  public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        ...
        "Least recently used arbitration unit with \"infiinite crossbar\" for hr_router", SST::Merlin::XbarArbitration)
  ...
  public:
    xbar_arb_lru_infx(ComponentId_t cid, Params & /*params*/) : XbarArbitration(cid) {}
