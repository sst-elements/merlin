...
class xbar_arb_lru : public XbarArbitration {
  ...
  public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(xbar_arb_lru, "merlin", "xbar_arb_lru", SST_ELI_ELEMENT_VERSION(1, 0, 0),
  ...
  public:
    xbar_arb_lru(ComponentId_t cid, Params & /*param*/) : XbarArbitration(cid) {}
