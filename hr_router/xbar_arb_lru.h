...
class xbar_arb_lru : public XbarArbitration {
   public:
    SST_ELI_REGISTER_SUBCOMPONENT(xbar_arb_lru, "merlin", "xbar_arb_lru",
   ...
   public:
    xbar_arb_lru(Component *parent, Params & /*param*/) : XbarArbitration(parent) {}

    ~xbar_arb_lru() override = default;
    ...
    void arbitrate(
        ...
        //     std::cout << priority[cur_list][i].first << ", " << priority[cur_list][i].second <<
        //     std::endl;
        // }
        // std::cout << "---------" << std::endl;
