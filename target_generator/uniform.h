...
class UniformDist : public TargetGenerator {
  ...
  public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(UniformDist, "merlin", "targetgen.uniform", SST_ELI_ELEMENT_VERSION(0, 0, 1),
                                          "Generates a uniform random set of target IDs.", SST::Merlin::TargetGenerator)
  ...
  public:
    UniformDist(ComponentId_t cid, Params &params, int id, int num_peers) : TargetGenerator(cid) {
