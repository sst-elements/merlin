...
class bisection_test : public Component {
  ...
  public:
    SST_ELI_REGISTER_COMPONENT(bisection_test, "merlin", "bisection_test", SST_ELI_ELEMENT_VERSION(0, 9, 0),
                               "Simple NIC to test bisection bandwidth of a network.", COMPONENT_CATEGORY_NETWORK)
...
class bisection_test_event : public Event {
  ...
  public:
    ...
    Event *clone() override { return new bisection_test_event(*this); }
