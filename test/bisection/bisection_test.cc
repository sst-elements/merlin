...
//    cout << "packets_to_send = " << packets_to_send << endl;
            ...
            link_control = (SST::Interfaces::SimpleNetwork *) loadSubComponent(networkIF, this,
                                                                               params);
            ...
            link_control->setNotifyOnReceive(
                new SST::Interfaces::SimpleNetwork::Handler<bisection_test>(this,
                                                                            &bisection_test::receive_handler));

            // Set up a send functor that will handle sending packets
            link_control->setNotifyOnSend(
                new SST::Interfaces::SimpleNetwork::Handler<bisection_test>(this,
                                                                            &bisection_test::send_handler));


            self_link = configureSelfLink("complete_link", "2GHz",
                                          new Event::Handler<bisection_test>(this,
                                                                             &bisection_test::handle_complete));
