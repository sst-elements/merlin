...
class nic : public Component {
   public:
    SST_ELI_REGISTER_COMPONENT(nic, "merlin", "test_nic", SST_ELI_ELEMENT_VERSION(1, 0, 0),
                               "Simple NIC to test base functionality.", COMPONENT_CATEGORY_NETWORK)
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"message_size",
         "Size of each message to be sent specified in either b or B (can include SI prefix)."},
        ...
        {"in_buf_size",
         "Size of linkcontrol input buffer specified in either b/s or B/s (can include SI prefix).",
         "1kB"},
        {"out_buf_size",
         "Size of linkcontrol output buffer specified in either b/s or B/s (can include SI "
         "prefix).",
         "1kB"},
