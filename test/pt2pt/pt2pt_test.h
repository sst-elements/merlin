...
class pt2pt_test : public Component {
   public:
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"buffer_size",
         "Size of input and output buffers specified in b or B (can include SI prefix)."},
...
class pt2pt_test_event : public Event {
   public:
    ...
    auto clone() -> Event * override { return new pt2pt_test_event(*this); }
