...
class pt2pt_test : public Component {
  ...
  public:
    SST_ELI_REGISTER_COMPONENT(pt2pt_test, "merlin", "pt2pt_test", SST_ELI_ELEMENT_VERSION(0, 9, 0),
                               "Simple NIC to test basic pt2pt performance.", COMPONENT_CATEGORY_NETWORK)
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"src", "Array of IDs of NICs that will send data."}, {"dest", "Array of IDs of NICs to send data to."},
        {"stream_delays",
         "Array of times before starting each of the streams.  Default is to start all of them at simulation start."},
...
class pt2pt_test_event : public Event {
  ...
  public:
    ...
    pt2pt_test_event() = default;

    Event *clone() override { return new pt2pt_test_event(*this); }
