...
class Bridge : public SST::Component {
  public:
    ...
    SST_ELI_DOCUMENT_PARAMS({"translator", "Translator backend.  Inherit from SST::Merlin::Bridge::Translator.",
                             nullptr},
    ...
    SST_ELI_DOCUMENT_STATISTICS({"pkts_received_net0", "Total number of packets recived on NIC0", "count", 1},
    ...
    class Translator : public SST::SubComponent {
      ...
      public:
        ...
        SimpleNetwork::nid_t getAddrForNetwork(uint8_t netID) { return bridge->getAddrForNetwork(netID); }
    };
