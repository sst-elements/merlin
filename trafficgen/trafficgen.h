...
class TrafficGen : public Component {
  ...
  public:
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"PacketDest:pattern", "Address pattern to be used (NearestNeighbor, Uniform, HotSpot, Normal, Binomial)",
         nullptr},
        ...
        {"PacketSize:Seed", "Sets the seed of the RNG", "11"}, {"PacketSize:RangeMax", "Minumum size of packets.", "0"},
  ...
  private:
    ...
    class NearestNeighbor : public Generator {
      ...
      public:
        NearestNeighbor(Generator *dist, int id, int maxX, int maxY, int maxZ, int numNeighbors) : dist(dist) {
            int myX = id % maxX;
    ...
    class ExponentialDist : public Generator {
      ...
      public:
        ...
        int getNextValue() override { return (int)dist->getNextDouble(); }
    ...
    class DiscreteDist : public Generator {
      ...
      public:
        ...
        int getNextValue() override { return ((int)dist->getNextDouble()) + minValue; }

        void seed(uint32_t val) override { gen = new MersenneRNG((unsigned int)val); }
    };
